...
{
    public sealed class CreateOpportunityHandler : GeneratedHandler
    {
        public CreateOpportunityHandler(
            ILogger<CreateOpportunityHandler> logger,
        ...
        protected override string PathTemplate => "/Opportunities";
