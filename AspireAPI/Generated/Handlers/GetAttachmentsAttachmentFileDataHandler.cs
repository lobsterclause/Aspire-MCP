...
{
    public sealed class GetAttachmentsAttachmentFileDataHandler : GeneratedHandler
    {
        public GetAttachmentsAttachmentFileDataHandler(
            ILogger<GetAttachmentsAttachmentFileDataHandler> logger,
        ...
        protected override string PathTemplate => "/Attachments/AttachmentFileData";
