...
{
    public sealed class ListActivityCategoryHandler : GeneratedHandler
    {
        public ListActivityCategoryHandler(
            ILogger<ListActivityCategoryHandler> logger,
        ...
        protected override string PathTemplate => "/ActivityCategories";
