...
{
    public sealed class ListActivityCommentHistoryHandler : GeneratedHandler
    {
        public ListActivityCommentHistoryHandler(
            ILogger<ListActivityCommentHistoryHandler> logger,
        ...
        protected override string PathTemplate => "/ActivityCommentHistories";
