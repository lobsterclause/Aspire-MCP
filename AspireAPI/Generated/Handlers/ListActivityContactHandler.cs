...
{
    public sealed class ListActivityContactHandler : GeneratedHandler
    {
        public ListActivityContactHandler(
            ILogger<ListActivityContactHandler> logger,
        ...
        protected override string PathTemplate => "/ActivityContacts";
