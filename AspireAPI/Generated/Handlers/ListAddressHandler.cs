...
{
    public sealed class ListAddressHandler : GeneratedHandler
    {
        public ListAddressHandler(
            ILogger<ListAddressHandler> logger,
        ...
        protected override string PathTemplate => "/Addresses";
