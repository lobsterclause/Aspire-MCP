...
{
    public sealed class ListBankDepositHandler : GeneratedHandler
    {
        public ListBankDepositHandler(
            ILogger<ListBankDepositHandler> logger,
        ...
        protected override string PathTemplate => "/BankDeposits";
