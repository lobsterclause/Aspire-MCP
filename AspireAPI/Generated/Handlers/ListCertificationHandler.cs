...
{
    public sealed class ListCertificationHandler : GeneratedHandler
    {
        public ListCertificationHandler(
            ILogger<ListCertificationHandler> logger,
        ...
        protected override string PathTemplate => "/Certifications";
