...
{
    public sealed class ListCertificationTypeHandler : GeneratedHandler
    {
        public ListCertificationTypeHandler(
            ILogger<ListCertificationTypeHandler> logger,
        ...
        protected override string PathTemplate => "/CertificationTypes";
