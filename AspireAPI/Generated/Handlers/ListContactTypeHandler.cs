...
{
    public sealed class ListContactTypeHandler : GeneratedHandler
    {
        public ListContactTypeHandler(
            ILogger<ListContactTypeHandler> logger,
        ...
        protected override string PathTemplate => "/ContactTypes";
