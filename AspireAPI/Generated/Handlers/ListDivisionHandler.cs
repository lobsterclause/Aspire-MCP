...
{
    public sealed class ListDivisionHandler : GeneratedHandler
    {
        public ListDivisionHandler(
            ILogger<ListDivisionHandler> logger,
        ...
        protected override string PathTemplate => "/Divisions";
