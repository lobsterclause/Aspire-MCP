...
{
    public sealed class ListEmployeeIncidentTypeHandler : GeneratedHandler
    {
        public ListEmployeeIncidentTypeHandler(
            ILogger<ListEmployeeIncidentTypeHandler> logger,
        ...
        protected override string PathTemplate => "/EmployeeIncidentTypes";
