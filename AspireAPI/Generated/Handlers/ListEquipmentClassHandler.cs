...
{
    public sealed class ListEquipmentClassHandler : GeneratedHandler
    {
        public ListEquipmentClassHandler(
            ILogger<ListEquipmentClassHandler> logger,
        ...
        protected override string PathTemplate => "/EquipmentClasses";
