...
{
    public sealed class ListEquipmentDisposalReasonHandler : GeneratedHandler
    {
        public ListEquipmentDisposalReasonHandler(
            ILogger<ListEquipmentDisposalReasonHandler> logger,
        ...
        protected override string PathTemplate => "/EquipmentDisposalReasons";
