...
{
    public sealed class ListEquipmentRequestedServiceHandler : GeneratedHandler
    {
        public ListEquipmentRequestedServiceHandler(
            ILogger<ListEquipmentRequestedServiceHandler> logger,
        ...
        protected override string PathTemplate => "/EquipmentRequestedServices";
