...
{
    public sealed class ListEquipmentServiceLogHandler : GeneratedHandler
    {
        public ListEquipmentServiceLogHandler(
            ILogger<ListEquipmentServiceLogHandler> logger,
        ...
        protected override string PathTemplate => "/EquipmentServiceLogs";
