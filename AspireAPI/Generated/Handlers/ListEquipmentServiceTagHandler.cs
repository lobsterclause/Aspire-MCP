...
{
    public sealed class ListEquipmentServiceTagHandler : GeneratedHandler
    {
        public ListEquipmentServiceTagHandler(
            ILogger<ListEquipmentServiceTagHandler> logger,
        ...
        protected override string PathTemplate => "/EquipmentServiceTags";
