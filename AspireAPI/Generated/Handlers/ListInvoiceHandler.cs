...
{
    public sealed class ListInvoiceHandler : GeneratedHandler
    {
        public ListInvoiceHandler(
            ILogger<ListInvoiceHandler> logger,
        ...
        protected override string PathTemplate => "/Invoices";
