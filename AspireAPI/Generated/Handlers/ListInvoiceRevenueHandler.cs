...
{
    public sealed class ListInvoiceRevenueHandler : GeneratedHandler
    {
        public ListInvoiceRevenueHandler(
            ILogger<ListInvoiceRevenueHandler> logger,
        ...
        protected override string PathTemplate => "/InvoiceRevenues";
