...
{
    public sealed class ListJobStatusHandler : GeneratedHandler
    {
        public ListJobStatusHandler(
            ILogger<ListJobStatusHandler> logger,
        ...
        protected override string PathTemplate => "/JobStatuses";
