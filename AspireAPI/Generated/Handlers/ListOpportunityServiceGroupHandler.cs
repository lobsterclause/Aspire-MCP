...
{
    public sealed class ListOpportunityServiceGroupHandler : GeneratedHandler
    {
        public ListOpportunityServiceGroupHandler(
            ILogger<ListOpportunityServiceGroupHandler> logger,
        ...
        protected override string PathTemplate => "/OpportunityServiceGroups";
