...
{
    public sealed class ListOpportunityServiceHandler : GeneratedHandler
    {
        public ListOpportunityServiceHandler(
            ILogger<ListOpportunityServiceHandler> logger,
        ...
        protected override string PathTemplate => "/OpportunityServices";
