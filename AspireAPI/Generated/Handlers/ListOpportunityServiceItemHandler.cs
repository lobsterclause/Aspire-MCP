...
{
    public sealed class ListOpportunityServiceItemHandler : GeneratedHandler
    {
        public ListOpportunityServiceItemHandler(
            ILogger<ListOpportunityServiceItemHandler> logger,
        ...
        protected override string PathTemplate => "/OpportunityServiceItems";
