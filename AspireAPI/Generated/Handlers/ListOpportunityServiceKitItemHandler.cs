...
{
    public sealed class ListOpportunityServiceKitItemHandler : GeneratedHandler
    {
        public ListOpportunityServiceKitItemHandler(
            ILogger<ListOpportunityServiceKitItemHandler> logger,
        ...
        protected override string PathTemplate => "/OpportunityServiceKitItems";
