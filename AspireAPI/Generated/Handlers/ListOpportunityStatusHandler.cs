...
{
    public sealed class ListOpportunityStatusHandler : GeneratedHandler
    {
        public ListOpportunityStatusHandler(
            ILogger<ListOpportunityStatusHandler> logger,
        ...
        protected override string PathTemplate => "/OpportunityStatuses";
