...
{
    public sealed class ListPayRateOverridePayCodeHandler : GeneratedHandler
    {
        public ListPayRateOverridePayCodeHandler(
            ILogger<ListPayRateOverridePayCodeHandler> logger,
