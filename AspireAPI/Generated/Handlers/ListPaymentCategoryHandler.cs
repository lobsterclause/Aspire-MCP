...
{
    public sealed class ListPaymentCategoryHandler : GeneratedHandler
    {
        public ListPaymentCategoryHandler(
            ILogger<ListPaymentCategoryHandler> logger,
        ...
        protected override string PathTemplate => "/PaymentCategories";
