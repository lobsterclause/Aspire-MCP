...
{
    public sealed class ListPaymentTermHandler : GeneratedHandler
    {
        public ListPaymentTermHandler(
            ILogger<ListPaymentTermHandler> logger,
        ...
        protected override string PathTemplate => "/PaymentTerms";
