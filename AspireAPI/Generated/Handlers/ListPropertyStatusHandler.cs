...
{
    public sealed class ListPropertyStatusHandler : GeneratedHandler
    {
        public ListPropertyStatusHandler(
            ILogger<ListPropertyStatusHandler> logger,
        ...
        protected override string PathTemplate => "/PropertyStatuses";
