...
{
    public sealed class ListPropertyTypeHandler : GeneratedHandler
    {
        public ListPropertyTypeHandler(
            ILogger<ListPropertyTypeHandler> logger,
        ...
        protected override string PathTemplate => "/PropertyTypes";
