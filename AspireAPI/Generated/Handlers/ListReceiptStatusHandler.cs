...
{
    public sealed class ListReceiptStatusHandler : GeneratedHandler
    {
        public ListReceiptStatusHandler(
            ILogger<ListReceiptStatusHandler> logger,
        ...
        protected override string PathTemplate => "/ReceiptStatuses";
