...
{
    public sealed class ListRegionHandler : GeneratedHandler
    {
        public ListRegionHandler(
            ILogger<ListRegionHandler> logger,
        ...
        protected override string PathTemplate => "/Regions";
