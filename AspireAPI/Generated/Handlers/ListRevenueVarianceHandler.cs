...
{
    public sealed class ListRevenueVarianceHandler : GeneratedHandler
    {
        public ListRevenueVarianceHandler(
            ILogger<ListRevenueVarianceHandler> logger,
        ...
        protected override string PathTemplate => "/RevenueVariances";
