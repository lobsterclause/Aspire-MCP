...
{
    public sealed class ListServiceTypeHandler : GeneratedHandler
    {
        public ListServiceTypeHandler(
            ILogger<ListServiceTypeHandler> logger,
        ...
        protected override string PathTemplate => "/ServiceTypes";
