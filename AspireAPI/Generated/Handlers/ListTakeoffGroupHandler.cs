...
{
    public sealed class ListTakeoffGroupHandler : GeneratedHandler
    {
        public ListTakeoffGroupHandler(
            ILogger<ListTakeoffGroupHandler> logger,
        ...
        protected override string PathTemplate => "/TakeoffGroups";
