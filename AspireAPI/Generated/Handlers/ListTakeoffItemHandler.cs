...
{
    public sealed class ListTakeoffItemHandler : GeneratedHandler
    {
        public ListTakeoffItemHandler(
            ILogger<ListTakeoffItemHandler> logger,
        ...
        protected override string PathTemplate => "/TakeoffItems";
