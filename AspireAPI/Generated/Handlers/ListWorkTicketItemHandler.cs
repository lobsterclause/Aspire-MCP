...
{
    public sealed class ListWorkTicketItemHandler : GeneratedHandler
    {
        public ListWorkTicketItemHandler(
            ILogger<ListWorkTicketItemHandler> logger,
        ...
        protected override string PathTemplate => "/WorkTicketItems";
