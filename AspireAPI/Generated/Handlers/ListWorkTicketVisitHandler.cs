...
{
    public sealed class ListWorkTicketVisitHandler : GeneratedHandler
    {
        public ListWorkTicketVisitHandler(
            ILogger<ListWorkTicketVisitHandler> logger,
        ...
        protected override string PathTemplate => "/WorkTicketVisits";
